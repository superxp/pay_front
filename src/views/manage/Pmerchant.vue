<template>
    <div>
        ...
        <p class="agency-top-text">拼多多账户管理商家列表</p>
    ...
    export default {
                                ...
                                h('Button', {
                                    ...
                                    on: {
                                        click: () => {
                                            ...
                                            this.compile.pddAccountId = params.row.pddAccountId
        ...
        methods: {
            ...
            ok4() {
                ...
                editgetpddAccount(params).then(res => {
                    if (res.status == 0) {
                        this.$Message.info('编辑成功');
                        this.delete()
                    }
