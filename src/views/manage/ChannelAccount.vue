        ...
        <div class="agency-box">
            <Modal
                ...
                <Form :label-width="80" v-model='fromData'>
                    <FormItem label="账号">
                        <Input v-model="fromData.account" placeholder="请输入通道名称"/>
                    </FormItem>
                    <FormItem label="私钥">
                        <Input v-model="fromData.signKey" placeholder="请输入限额"/>
                    </FormItem>
                    <FormItem label="公钥">
                        <Input v-model="fromData.publicKey" placeholder="请输入费率"/>
                    </FormItem>
                    <FormItem label="限额">
            ...
            <Modal
                ...
                <Form :label-width="80" v-model='fromlk'>
                    <FormItem label="账号">
                        <Input v-model="fromlk.account" placeholder="请输入通道名称"/>
                    </FormItem>
                    <FormItem label="私钥">
                        <Input v-model="fromlk.signKey" placeholder="请输入限额"/>
                    </FormItem>
                    <FormItem label="公钥">
                        <Input v-model="fromlk.publicKey" placeholder="请输入费率"/>
                    </FormItem>
                    <FormItem label="限额">
    ...
    export default {
                                ...
                                h('i-switch', {
                                        ...
                                        on: {
                                            'on-change': (value) => {
                                                ...
                                                updateChannelAccount(channel).then(res => {
        ...
        methods: {
            ...
            ok() {
                ...
                insertChannelAccount(params).then(res => {
                    console.log(res)
                    this.contains()
            ...
            ok2() {
                ...
                updateChannelAccount(params).then(res => {
                    console.log(res)
                    this.contains()
                }).catch(err => {
                    this.treeLoading = false;
            ...
            delete() {
                ...
                deleteChannelAccount(params).then(res => {
                    this.$Message.info(res.data);
                    this.contains()
